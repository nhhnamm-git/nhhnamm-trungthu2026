...
const wishList = [
  ...
  { text: "Trăng đêm nay đẹp lắm, nhưng vẫn chưa đẹp bằng nụ cười của cậu. Chúc cậu ngày nào cũng có lý do để cười thật tươi, và mỗi khi mệt mỏi thì có ai đó ở cạnh nhắc rằng cậu đã làm rất tốt rồi.", img: "./assets/3.jpg" },
  { text: "Chúc tình cảm của chúng ta tròn đầy như trăng rằm: không cần quá ồn ào, chỉ cần bền bỉ, ấm áp và chân thành. Mình sẽ luôn ở đây, cùng cậu đi qua những đêm trăng thật nhiều nữa.", img: "./assets/1.jpg" },
  { text: "Mong cậu được sống giữa những người biết trân trọng cậu, làm những việc khiến cậu thấy mình có ý nghĩa, và mỗi tối trở về nhà đều thấy lòng nhẹ nhõm, bình an.", img: "./assets/2.jpg" },
  { text: "Như chú Cuội ngồi gốc đa nhìn xuống trần gian, mong cậu cũng luôn có một góc nhỏ bình yên để nghỉ ngơi sau những ngày dài bận rộn. Ở đó, mọi mỏi mệt đều được xoa dịu.", img: "./assets/3.jpg" },
  { text: "Chúc cậu năm nay gặp nhiều may mắn, quý nhân phù trợ, mở lòng đón những cơ hội mới. Những cánh cửa từng đóng lại sẽ nhường chỗ cho những con đường rộng mở hơn.", img: "./assets/1.jpg" },
  { text: "Đêm rằm, hàng ngàn chiếc đèn lồng cùng thắp sáng. Mong cậu cũng luôn tìm thấy ánh sáng của riêng mình, đủ ấm để sưởi lòng cậu và đủ rộng để soi đường cho những người cậu thương.", img: "./assets/2.jpg" },
  { text: "Cảm ơn cậu vì đã luôn là một người đáng quý. Trung Thu này, mình chúc cậu nhận lại thật nhiều yêu thương, đúng bằng những gì cậu đã âm thầm trao đi cho mọi người xung quanh.", img: "./assets/3.jpg" },
  { text: "Chúc cậu và những người thân yêu luôn đủ đầy: đủ ấm áp để chống chọi giá lạnh, đủ bình tĩnh để vượt qua sóng gió, và đủ hạnh phúc để mỗi bữa cơm đều có tiếng cười.", img: "./assets/1.jpg" },
  { text: "Mong rằng những điều buồn bã của năm qua sẽ trôi đi như mây bên trăng, và những điều tốt đẹp sẽ ở lại, tròn đầy như chiếc bánh nướng thơm bùi trên bàn cỗ đêm nay.", img: "./assets/2.jpg" },
  { text: "Có những điều không cần nói thành lời, chỉ cần cùng nhau ngước lên nhìn cùng một vầng trăng. Chúc cậu đêm nay thấy lòng mình dịu lại, biết rằng luôn có người nghĩ đến cậu.", img: "./assets/3.jpg" },
  { text: "Chúc cậu dũng cảm theo đuổi ước mơ, dù đường còn xa hay gập ghềnh. Cứ đi từng bước một, ánh trăng sẽ luôn soi đường, và mình sẽ luôn tin ở cậu.", img: "./assets/1.jpg" },
  { text: "Mong cậu luôn có thời gian cho chính mình: một buổi sáng thong thả, một tách trà thơm, một bản nhạc hay. Bởi hạnh phúc lớn thường bắt đầu từ những khoảnh khắc nhỏ như vậy.", img: "./assets/2.jpg" },
  { text: "Trung Thu là dịp để đoàn viên. Dù cậu đang ở gần hay xa gia đình, mong mỗi cuộc gọi, mỗi tin nhắn hôm nay đều mang theo hơi ấm, để cậu biết mình chưa bao giờ đơn độc.", img: "./assets/3.jpg" },
  { text: "Chúc riêng cậu một đêm trăng thật lãng mạn và ngọt ngào, có gió nhẹ, có hương hoa bưởi, có ánh đèn lồng lung linh và có một người nắm tay cậu thật lâu thật chặt.", img: "./assets/1.jpg" },
  { text: "Mong sự nghiệp của cậu như vầng trăng lên cao: thong thả nhưng vững vàng, ngày càng sáng rõ. Mọi cố gắng hôm nay đều đang lặng lẽ xây nên một tương lai rực rỡ cho cậu.", img: "./assets/2.jpg" },
  { text: "Chúc cậu luôn giữ được sự dịu dàng với chính mình. Cậu không cần hoàn hảo, cũng không cần vội vàng. Chỉ cần mỗi ngày trôi qua, cậu đều thấy bản thân đang lớn lên và tốt đẹp hơn một chút.", img: "./assets/3.jpg" },
  { text: "Đèn ông sao lấp lánh, tiếng trống lân rộn ràng, mong niềm vui của đêm hội hôm nay sẽ theo cậu đến tận những ngày sau, để mỗi khi nhớ lại, cậu đều mỉm cười.", img: "./assets/1.jpg" },
  { text: "Mong mọi điều cậu gửi vào chiếc đèn lồng đêm nay sẽ bay thật cao, chạm đến vầng trăng và quay về với cậu dưới dạng những tin vui, những cái ôm ấm áp và những ngày bình yên.", img: "./assets/2.jpg" },
  { text: "Trung Thu an lành, cậu nhé. Chúc cậu vạn sự như ý, tâm luôn an, người luôn khỏe, tình luôn đầy, và mỗi năm trăng rằm đến đều thấy mình hạnh phúc hơn năm trước.", img: "./assets/3.jpg" },
];
